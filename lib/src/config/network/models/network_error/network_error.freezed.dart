...
class _$_ResponseError extends _ResponseError with DiagnosticableTreeMixin {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties
      ..add(DiagnosticsProperty('type', 'NetworkError.request'))
...
class _$_DecodingError extends _DecodingError with DiagnosticableTreeMixin {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties
      ..add(DiagnosticsProperty('type', 'NetworkError.type'))
      ..add(DiagnosticsProperty('error', error));
  }
...
class _$_Connectivity extends _Connectivity with DiagnosticableTreeMixin {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties
      ..add(DiagnosticsProperty('type', 'NetworkError.connectivity'))
